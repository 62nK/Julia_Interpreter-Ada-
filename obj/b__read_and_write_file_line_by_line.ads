...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_read_and_write_file_line_by_line" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#39ed9e02#;
   pragma Export (C, u00001, "read_and_write_file_line_by_lineB");
   ...
   --  ada.text_io%s
   --  ada.text_io%b
   --  read_and_write_file_line_by_line%b
